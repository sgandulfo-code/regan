          ...
          <div className="flex-1">
            ...
            <div className="relative max-w-md">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-200 rounded-xl text-lg font-bold text-slate-900 focus:outline-none focus:border-rose-300 focus:ring-4 focus:ring-rose-100 transition-all"
              />
            </div>
          </div>
