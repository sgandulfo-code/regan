        ...
        {property.clientCustomFields && Object.keys(property.clientCustomFields).length > 0 && (
          <div className="flex flex-wrap items-center gap-2 mt-3 pt-3 border-t border-slate-100">
            {Object.entries(property.clientCustomFields).map(([key, value]) => (
              <span key={key} className="bg-indigo-50 text-indigo-700 px-2 py-1 rounded-md text-xs font-bold uppercase tracking-wider flex items-center gap-1">
      ...
      <div className="flex flex-row md:flex-col items-center md:items-end gap-3 w-full md:w-auto justify-between md:justify-center border-t md:border-t-0 md:border-l border-slate-100 pt-3 md:pt-0 md:pl-4">
        ...
        <div className="flex items-center gap-2">
             <button 
                ...
                className={`px-3 py-2 rounded-xl border transition-all flex items-center justify-center gap-2 text-[10px] font-bold uppercase tracking-wider ${isCompared ? 'bg-indigo-50 border-indigo-200 text-indigo-600' : 'bg-white border-slate-200 text-slate-400 hover:border-indigo-200 hover:text-indigo-600'}`}
                title="Comparar"
            >
             ...
             <button 
                ...
                className="bg-white border border-slate-200 text-slate-600 px-3 py-2 rounded-xl text-[10px] font-bold uppercase tracking-wider hover:bg-slate-50 hover:text-indigo-600 transition-all flex items-center justify-center gap-2"
                title="Ver Ficha"
            >
                <ExternalLink className="w-3.5 h-3.5" />
                <span>Ver Ficha</span>
            ...
            <button 
                ...
                className="bg-indigo-600 text-white px-3 py-2 rounded-xl text-[10px] font-bold uppercase tracking-wider hover:bg-indigo-700 transition-all flex items-center justify-center gap-2 shadow-md shadow-indigo-200"
                title="Pedir Visita"
            >
